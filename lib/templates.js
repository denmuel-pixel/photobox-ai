...
export function getRandomPrompt(templateId, faceCount = 1) {
  ...
  if (templateId !== "enhance") {
    const preserve = `\n\nIMPORTANT: Preserve the original clothing, clothing patterns, accessories, and background exactly as they are. Only change the face, hair style, and overall artistic style. Do NOT alter or replace clothing patterns, logos, text on clothes, or background elements. Keep all original details intact.`;
